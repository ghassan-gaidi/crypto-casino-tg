...
// that reports the actual error instead of silent FUNCTION_INVOCATION_FAILED
let handler;
try {
...
/help — This message`, { parse_mode: 'Markdown' });
  ...
  handler = (0, grammy_1.webhookCallback)(bot, 'std/http', {
    secretToken: process.env.TELEGRAM_SECRET_TOKEN,
  });
}
catch (e) {
  // If anything fails at module init, create an error handler
